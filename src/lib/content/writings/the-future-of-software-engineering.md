...
The future of my profession is a difficult topic. It is difficult because when I think about it, I have to hold in my head convincing, yet opposite, arguments from well-known tech leaders and economists. Here are a few of those perspectives.
...
*Sources: [Lex Fridman Podcast #452 transcript](https://lexfridman.com/dario-amodei-transcript/) · [Machines of Loving Grace](https://darioamodei.com/machines-of-loving-grace) · [WEF Davos, The Economist](https://indianexpress.com/article/technology/artificial-intelligence/anthropic-ceo-dario-amodei-wef-davos-ai-jobs-10486848/) · [Dwarkesh Podcast #2](https://www.dwarkesh.com/p/dario-amodei-2) · [Axios: "A White-Collar Bloodbath"](https://www.axios.com/2025/05/28/ai-jobs-white-collar-unemployment-anthropic)*
...
*All quotations sourced from [Lex Fridman Podcast #494 — Jensen Huang: NVIDIA](https://lexfridman.com/jensen-huang-transcript/) · Published March 23, 2026.*
...
*Sources: [Marc Benioff on Agentforce & the Future of AI Agents in Slack, interview with Matthew Berman at the Slackbot Launch Event (YouTube, April 6, 2026)](https://www.youtube.com/watch?v=XY-s81fBXFU)*
...
*Sources: [LinkedIn — "Amdahl's Law for automation" (June 2025)](https://www.linkedin.com/posts/yann-lecun_most-jobs-involve-performing-many-tasks-activity-7342572373931356160-0N9u) · [Business Insider — "Daron Acemoglu Is Skeptical of Anthropic CEO's Dire Jobs Warning" (April 2026)](https://www.businessinsider.com/daron-acemoglu-economist-dario-amodei-ai-job-loss-yann-lecun-2026-4) · [Sahm Capital — "Ex-Meta Chief Scientist Yann LeCun Slams Anthropic CEO's Job Wipeout Warning" (April 2026)](https://www.sahmcapital.com/news/content/ex-meta-chief-scientist-yann-lecun-slams-anthropic-ceos-job-wipeout-warning-dario-is-wrong-he-knows-absolutely-nothing-2026-04-20) · [TechCrunch — "Yann LeCun's AMI Labs raises $1.03B to build world models" (March 2026)](https://techcrunch.com/2026/03/09/yann-lecuns-ami-labs-raises-1-03-billion-to-build-world-models/) · [Futurum — "AMI Labs Raises $1BN Seed Round" (March 2026)](https://futurumgroup.com/insights/yann-lecuns-ami-raises-1bn-seed-round-is-the-world-model-era-finally-here/)*
...
*Sources: [Erik Brynjolfsson, "AI Changed Work Forever in 2025," Time Magazine, January 2, 2026](https://time.com/7342494/ai-changed-work-forever/); [Fortune, "Top AI economist finds link between robots and minimum wage hikes," March 4, 2026](https://fortune.com/2026/03/04/minimum-wage-impact-on-manufacturing-jobs-robots-erik-brynjolfsson/); Erik Brynjolfsson and Andrew McAfee, The Second Machine Age (2014)*
...
*Sources: [Andrew McAfee, HBR Strategy Summit 2026 podcast, April 2026](https://hbr.org/podcast/2026/04/strategy-summit-2026-whos-going-to-succeed-with-ai) · [Andrew McAfee, The Permanent Problem podcast, March 2026](https://brinklindsey.substack.com/p/andrew-mcafee-on-the-future-of-innovation) · [MIT/Let's Data Science: "MIT Researcher Warns Against Cutting Entry-Level Hiring," April 2026](https://letsdatascience.com/news/mit-researcher-warns-against-cutting-entry-level-hiring-9969cb7c) · Andrew McAfee & Erik Brynjolfsson, The Second Machine Age (2014)*

## Moving forward

It seems that Dario Amodei is on one end of the spectrum ("white-collar bloodbath"), Jensen Huang is on the other ("headcount will grow"), and everyone else falls somewhere in between. Taking it all together, here are some assertions we can make:

- 1. **The nature of software engineering has already changed.** We wouldn't be having this conversation otherwise. We debate the current extent of the capability of agentic coding systems and the max capability they can reach. But we do not debate the fact that they *already* provide us with significant value. The engineers who use AI to the best of its capability will replace those who don't.

- 2. **Coding work will be replaced before software engineering jobs are.** The tasks within a job do not equal the job itself. As Erik Brynjolfsson points out, even if the majority of tasks in the SDLC get automated, people are still needed to ask the right questions and evaluate the results. Many people in an organization can ask good non-technical questions. We call them stakeholders. However, it is unclear whether the tooling will reach a point where those without a software engineering background can ask the right technical questions and evaluate the technical quality (security, durability, scalability) of the output.

- 3. **The employment consequences of new technologies are usually mispredicted.** Andrew McAfee, along with Jensen Huang and many others, references [Geoffrey Hinton's famous prediction](https://cancerworld.net/how-ai-is-assisting-not-replacing-radiologists/) that we should "stop training radiologists" because AI would soon outperform them at reading images. Hinton was right — models surpassed radiologists on many image-recognition benchmarks over the subsequent decade. And yet, the number of radiologists increased, reaching an all-time high in both number and salary in the early 2020s. It turns out that AI made it easier to justify more imaging. With faster triage and prioritization, radiology departments could handle higher volumes, which in turn encouraged more use of imaging. This is the classic Jevons paradox: as AI makes a task cheaper and faster, total consumption of the task increases, offsetting individual productivity gains.

The future is not guaranteed. The 13% drop in early-career employment is real, but a labor market freezing in uncertainty is not necessarily a projection. The question that decides the next decade is whether the radiologist story repeats. If cheaper software follows the Jevons paradox the way cheaper imaging did, then lowering the cost to build means more software worth building, and demand for the people who specify and evaluate it grows the way Jensen and Erik describe. If instead the job stays fixed while its tasks drain away to automation, McAfee's decades-long squeeze is just as plausible.

For those considering this career: know that you are taking a risk. For those of us already in it, take this uncertainty as reason to act, not to wait. Use these tools to take on problems we wouldn't have considered before. And, keep hiring and developing juniors while the shape of the job is still being negotiated, because those that cut the pipeline now will have no one who learned to ask the right questions later.
